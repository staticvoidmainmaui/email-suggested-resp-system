...
let me see an example , we parse the JSON data into objects but dont check the spelling or what do we not check or whats the bare minimum we do check

Moment data enters system we make a threat.
